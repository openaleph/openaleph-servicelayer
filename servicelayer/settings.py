...
ARCHIVE_API_SECRET = env.get("ARCHIVE_API_SECRET")
ARCHIVE_API_PRESIGN_KEY = env.get("ARCHIVE_API_PRESIGN_KEY") or ARCHIVE_API_KEY
ARCHIVE_API_PRESIGN_SECRET = env.get("ARCHIVE_API_PRESIGN_SECRET") or ARCHIVE_API_SECRET
ARCHIVE_API_PRESIGN_URL = env.get("ARCHIVE_API_PRESIGN_URL")
